...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"
	...
	max-width: 560px;" class="wrapper">
			...
			color: #F0F0F0;" class="preheader">
                        ...
                        <a target="_blank" style="text-decoration: none;"
                           href="{{ config('app.url') }}"><h3 class="app-name">{{ config('app.name') }}</h3></a>
	...
	max-width: 560px;" class="container">
			...
			font-family: sans-serif;" class="header">
                ...
                <!-- Set text color and font family ("sans-serif" or "Georgia, serif") -->
                <tr>
                    <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-bottom: 3px; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 10px; font-weight: 300; line-height: 150%;
                			padding-top: 5px;
                			color: #000000;
                			font-family: sans-serif;" class="subheader">
                        {!! __('translate.platform_message', ['url' => config('app.url')]) !!}
                ...
                <tr>
                    <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
			padding-top: 0" class="hero"><a target="_blank" style="text-decoration: none;"
                            ...
                            <table class="request-table">
                                @foreach($content as $key => $value)
                                    <tr>
                                        ...
                                        @if(in_array($key, ['file', 'image']))
                                            <td><a target="_blank" href="{{ $value }}">Bax</a></td>
                                        @else
                                            <td>{{ $value }}</td>
                                        @endif
                                    </tr>
