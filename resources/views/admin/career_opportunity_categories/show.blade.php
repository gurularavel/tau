                            ...
                            {{-- <div class="col-lg-4">
                                <div class="sticky-side-div">
                                    <div class="card ribbon-box border shadow-none right">
                                        <img src="{{getImage('career_opportunity_categories', $model->image)}}" alt="{{$title}}" class="img-fluid rounded " data-fancybox="gallery" style="cursor: zoom-in;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="table-center">
                                                                        @switch($attribute)
                                                                            ...
                                                                            @case('actions')
                                                                            <x-admin.crud.index.actions :model="$model" :routeName="'career_opportunity_categories'" :td="false" :view="false" :delete="true"/>
