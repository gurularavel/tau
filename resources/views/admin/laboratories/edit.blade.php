<x-admin.layout>
    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'laboratories.update'" :method="'update'" :model="$model" :routeNameForBackButton="'laboratoryPage'"
                    :frontRouteName="'laboratories.show'">
    ...
    <x-admin.crud.image.card :title="$title">
        <x-admin.crud.image.card-body>
            <x-admin.crud.image.main-image :columnValue="$model->image" :name="'image'" :folderName="'laboratories'" />
            <x-admin.crud.image.other-images :model="$model" :routeName="'laboratories'" :imageFolder="'laboratory_images'" />
