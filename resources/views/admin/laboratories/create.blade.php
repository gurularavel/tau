    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'laboratories.store'" :method="'post'" :routeNameForBackButton="'laboratories'">
                    ...
                    <x-admin.crud.image.card :title="$title">
                        <x-admin.crud.image.card-body>
                            <x-admin.crud.image.main-image :columnValue="''" :name="'image'" :folderName="'laboratories'" />
                            <x-admin.crud.image.other-images :model="''" :routeName="'laboratories'" :imageFolder="'laboratory_images'" />
