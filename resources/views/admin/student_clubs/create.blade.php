    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'student_clubs.store'" :method="'post'" :routeNameForBackButton="'student_clubs'">
                    ...
                    <x-admin.crud.image.card :title="$title">
                        <x-admin.crud.image.card-body>
                            <x-admin.crud.image.main-image :columnValue="''" :name="'image'" :folderName="'student_clubs'" />
                            <x-admin.crud.image.other-images :model="''" :routeName="'student_clubs'" :imageFolder="'student_club_images'" />
