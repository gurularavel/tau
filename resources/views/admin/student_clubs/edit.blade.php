<x-admin.layout>
    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'student_clubs.update'" :method="'update'" :model="$model" :routeNameForBackButton="'studentClubPage'"
                    :frontRouteName="'student_clubs.show'">
    ...
    <x-admin.crud.image.card :title="$title">
        <x-admin.crud.image.card-body>
            <x-admin.crud.image.main-image :columnValue="$model->image" :name="'image'" :folderName="'student_clubs'" />
            <x-admin.crud.image.other-images :model="$model" :routeName="'student_clubs'" :imageFolder="'student_club_images'" />
