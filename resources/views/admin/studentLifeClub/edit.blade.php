    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                    ...
                    <x-admin.crud.card :routeName="'studentLifeClub.update'" :method="'update'" :model="$model" :routeNameForBackButton="''" :frontRouteName="''" >
                                ...
                                <x-admin.crud.image.card :title="$title">
                                    <x-admin.crud.image.card-body>
                                        <x-admin.crud.image.main-image :columnValue="$model->image" :name="'image'" :folderName="'studentLifeClub'"/>
                                    </x-admin.crud.image.card-body>
