                            ...
                            <div class="col-lg-4">
                                <div class="sticky-side-div">
                                    <div class="card ribbon-box border shadow-none right">
                                        <img src="{{ getImage('internship_programs', $model->image) }}" alt="" class="img-fluid rounded" data-fancybox="gallery" style="cursor: zoom-in;">
                                                                    ...
                                                                    <td class="table-center">
                                                                        ...
                                                                        @case('is_active')
                                                                            ...
                                                                            @case('project_category_id')
                                                                               <a target="__blank" href="{{ route('admin.project_categories.show', $model->category->id) }}">{{ $model->category?->title }}</a>
                                                                                @break

                                                                            @case('actions')
                                                                                <x-admin.crud.index.actions :model="$model" :routeName="'internship_programs'" :td="false" :view="false" :delete="true" :frontRouteName="'front.internship_programs'"/>
                                                                                @break
