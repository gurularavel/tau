                            ...
                            <div class="col-lg-4">
                                <div class="sticky-side-div">
                                    <div class="card ribbon-box border shadow-none right">
                                        <img src="{{ getImage('projects', $model->image) }}" alt=""
                                                                ...
                                                                <td class="table-center">
                                                                    @switch($attribute)
                                                                        ...
                                                                        @case('project_category_id')
                                                                            <a target="__blank"
                                                                                href="{{ route('admin.project_categories.show', $model->category->id) }}">{{ $model->category?->title }}</a>
                                                                        @break
                                                                            ...
                                                                            <div class="flex flex-wrap gap-5">
                                                                                <div class="flex flex-wrap gap-4">
                                                                                    @foreach ($model->images as $gallery)
                                                                                        <a href="{{ asset('uploads/project_images/' . $gallery->image) }}"
                                                                        ...
                                                                        @case('actions')
                                                                            <x-admin.crud.index.actions :model="$model"
                                                                                :routeName="'projects'" :td="false"
                                                                                :view="false" :delete="true"
                                                                                :frontRouteName="'front.projects'" />
                                                                        @break
