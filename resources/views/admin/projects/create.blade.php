    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'projects.store'" :method="'post'" :routeNameForBackButton="'projects'">
                        ...
                        @foreach ($locales as $key => $locale)
                            <x-admin.crud.tab-pane :key="$key">
                                <x-admin.crud.card-body-row>
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <x-admin.crud.input :locale="$locale" :model="''" :columnName="'author'"
                                    ...
                                    <div class="project-items-wrapper" data-locale="{{ $locale }}">
                                        <div class="d-flex gap-2 mb-2 project-item-row">
                                            <input type="text" name="project_items[0][{{ $locale }}][title]"
                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="mb-3 col-lg-4">
                                <x-admin.crud.input :locale="''" :model="''" :columnName="'publisher_count'"
                                    :label="'Publisher count'" :placeholder="'Publisher count'" :type="'number'" :required="false" />
                            </div>
                            <div class="mb-3 col-lg-4">
                                <x-admin.crud.input :locale="''" :model="''" :columnName="'participant_count'"
                            ...
                            <div class="mb-3 col-lg-4">
                                <x-admin.crud.input :locale="''" :model="''" :columnName="'partners'"
                    ...
                    <x-admin.crud.image.card :title="$title">
                        <x-admin.crud.image.card-body>
                            <x-admin.crud.image.main-image :columnValue="''" :name="'image'" :folderName="'projects'" />
                            <x-admin.crud.image.other-images :model="''" :routeName="'projects'" :imageFolder="'project_images'" />
