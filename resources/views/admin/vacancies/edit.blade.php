    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'vacancies.update'" :method="'update'" :model="$model" :routeNameForBackButton="'vacancies'" :frontRouteName="'careerPage.show'">
                            ...
                            <x-admin.crud.tab-pane :key="$key">
                                <x-admin.crud.card-body-row>
                                    ...
                                    <div class="mb-3 col-lg-4">
                                        <x-admin.crud.input :locale="$locale" :model="$model" :columnName="'status_text'"
                    ...
                    {{-- Tərcümə olunmayan sahələr üçün ortaq bölmə --}}
                    <div class="card">
                        <div class="card-body row">

                            <div class="mb-3 col-lg-4">
                                <x-admin.crud.input :locale="''" :model="$model" :columnName="'published_at'"
                                    :label="'Published date'" :placeholder="'Published date'" :type="'date'" :required="false" />
                            </div>

                            {{-- YENİ: Son müraciət tarixi (Deadline) --}}
                            <div class="mb-3 col-lg-4">
                                <x-admin.crud.input :locale="''" :model="$model" :columnName="'deadline'"
