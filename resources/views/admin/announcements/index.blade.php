        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.index.card>
                    ...
                    <x-admin.crud.index.card-header :title="$title" :routeName="'announcements'" />
                                    ...
                                    <x-admin.crud.index.table-tbody>
                                        ...
                                        @forelse($models as $model)
                                            <tr>
                                                ...
                                                <x-admin.crud.index.image :columnName="$model->image" :folderName="'announcements'" />
                                                ...
                                                <x-admin.crud.index.actions :model="$model" :routeName="'announcements'"
                                                    :frontRouteName="'front.announcements'" :view="false" :delete2="true"/>
                                                @php $count++ @endphp
