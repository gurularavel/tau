    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'announcements.update'" :method="'update'" :model="$model" :routeNameForBackButton="'announcements'"
                    :frontRouteName="'announcements.show'">
                    ...
                    @if ($model->images)
                        <x-admin.crud.image.card :title="$title">
                            <x-admin.crud.image.card-body>
                                ...
                                {{-- <x-admin.crud.image.other-images :model="$model" :routeName="'announcements'"
                                    :imageFolder="'announcements_images'" /> --}}
                            </x-admin.crud.image.card-body>
