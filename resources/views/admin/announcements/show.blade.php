                            ...
                            <div class="col-lg-4">
                                <div class="sticky-side-div">
                                    <div class="card ribbon-box border shadow-none right">
                                        <img src="{{asset('uploads/announcements/' . $model->image)}}" alt="" class="img-fluid rounded">
                                                                            ...
                                                                            <div class="flex flex-wrap gap-5">
                                                                                <div class="flex flex-wrap gap-4">
                                                                                    @foreach($model->images as $gallery)
                                                                                        <a href="{{ asset('uploads/announcements_images/' . $gallery->image) }}" data-fancybox="gallery">
                                                                                            {!! image('announcements_images', $gallery->image, null, $model->title, 'cursor-pointer', 'width:125px; height:80px; border-radius: 10px; margin: 5px;') !!}
                                                                                        </a>
                                                                                    @endforeach
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                @break
                                                                                      @case('actions')
                                                                                <x-admin.crud.index.actions :model="$model" :routeName="'announcements'" :td="false" :view="false" :delete="true" :frontRouteName="null"/>
                                                                                @break
                                                                            @default
                                                                                {!! $model->{$attribute} !!}
                                                                        @endswitch
