        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.index.card>
                    ...
                    <x-admin.crud.index.card-header :title="'Languages'" :routeName="'languages'"/>
                                    ...
                                    <x-admin.crud.index.table-tbody>
                                        ...
                                        @forelse($models as $model)
                                            <tr>
                                                ...
                                                <x-admin.crud.index.title  :columnName="$model->locale" />
                                                <x-admin.crud.index.status :model="$model" :name="'is_main'"/>
                                                <x-admin.crud.index.status :model="$model" :name="'is_active'"/>
                                                <x-admin.crud.index.actions :model="$model" :routeName="'languages'"/>
                                             @php $count++ @endphp
