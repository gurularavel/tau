                            ...
                            <div class="col-lg-4">
                                <div class="sticky-side-div">
                                    <div class="card ribbon-box border shadow-none right">
                                        <img src="{{ getImage('partners', $model->image) }}" alt="" class="img-fluid rounded" data-fancybox="gallery" style="cursor: zoom-in;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="table-center">
                                                                        ...
                                                                        @case('is_active')
                                                                            ...
                                                                            @case('actions')
                                                                                <x-admin.crud.index.actions :model="$model" :routeName="'partners'" :td="false" :view="false" :delete="true"/>
                                                                                @break
