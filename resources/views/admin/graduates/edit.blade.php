<x-admin.layout>
    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'graduates.update'" :method="'update'" :model="$model" :routeNameForBackButton="'graduatePage'"
                    :frontRouteName="'graduates.show'">
                            ...
                            <x-admin.crud.tab-pane :key="$key">
                                ...
                                <x-admin.crud.card-body-row>
                                    ...
                                    <div class="mb-3 col-lg-12">
                                     ...
                                     <div class="mb-3 col-lg-12">
                                        <x-admin.crud.input :locale="$locale" :model="$model" :columnName="'profession'"
    ...
    <x-admin.crud.image.card :title="$title">
        <x-admin.crud.image.card-body>
            <x-admin.crud.image.main-image :columnValue="$model->image" :name="'image'" :folderName="'graduates'" />
