                            ...
                            <div class="col-lg-4">
                                <div class="sticky-side-div">
                                    <div class="card ribbon-box border shadow-none right">
                                        <img src="{{asset('uploads/academic_calendars/' . $model->image)}}" alt="" class="img-fluid rounded">
                                                                            ...
                                                                            <div class="flex flex-wrap gap-5">
                                                                                <div class="flex flex-wrap gap-4">
                                                                                    @foreach($model->images as $gallery)
                                                                                        <a href="{{ asset('uploads/academic_calendars_images/' . $gallery->image) }}" data-fancybox="gallery">
                                                                                            {!! image('academic_calendars_images', $gallery->image, null, $model->title, 'cursor-pointer', 'width:125px; height:80px; border-radius: 10px; margin: 5px;') !!}
                                                                                        </a>
                                                                                    @endforeach
                                                                                </div>
                                                                            </div>
