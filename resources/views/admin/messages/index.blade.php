        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.index.card>
                    ...
                    <x-admin.crud.index.card-header :title="$title" :routeName="'messages'"/>
                                    ...
                                    <x-admin.crud.index.table-tbody>
                                        ...
                                        @forelse($models as $model)
                                            <tr>
                                                ...
                                                <x-admin.crud.index.title  :columnName="$model->phone" />
                                                <x-admin.crud.index.title  :columnName="$model->read_at" />
                                                <x-admin.crud.index.actions :model="$model" :routeName="'messages'" :view="true" :delete="true" :delete2="true"/>
                                                    @php
                                                        $count++
                                                    @endphp
                                            </tr>
