                                            ...
                                            <div class="d-flex gap-2 mb-2 footer-item-row">
                                                ...
                                                <div class="d-flex gap-2 w-100 slug-container">
                                                    ...
                                                    <input type="text" name="footer_items[{{ $item->id }}][{{ $locale }}][slug_manual]"
                                                        class="form-control slug-manual" value="{{ !str_starts_with($item->slug ?? '', 'http') ? ($item->slug ?? '') : '' }}" placeholder="Custom slug">

                                                    <input type="url" name="footer_items[{{ $item->id }}][{{ $locale }}][slug_external]"
                                                        class="form-control slug-external" value="{{ str_starts_with($item->slug ?? '', 'http') ? $item->slug : '' }}" placeholder="https://external-link.com">
                                                </div>
