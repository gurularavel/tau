    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'mediaGuidePage.update'" :method="'update'" :model="$model" :back="true" :frontRouteName="'mediaGuidePage.index'">
                    ...
                    <x-admin.crud.image.card :title="$title">
                        <x-admin.crud.image.card-body>
                            ...
                            <x-admin.crud.image.other-images :model="$model" :routeName="'mediaGuidePage'"
                                                            :imageFolder="'media_guide_page_images'" />
