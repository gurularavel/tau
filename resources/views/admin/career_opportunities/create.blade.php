    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'career_opportunities.store'" :method="'post'" :routeNameForBackButton="'career_opportunities'">
                    ...
                    <x-admin.crud.image.card :title="$title">
                        <x-admin.crud.image.card-body>
                            <x-admin.crud.image.main-image :columnValue="''" :name="'image'" :folderName="'career_opportunities'" />
                            {{-- <x-admin.crud.image.other-images :model="''" :routeName="'career_opportunities'" :imageFolder="'career_opportunity_images'" /> --}}
