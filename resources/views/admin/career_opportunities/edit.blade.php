    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'career_opportunities.update'" :method="'update'" :model="$model" :routeNameForBackButton="'career_opportunities'"
                    :frontRouteName="'career_opportunities.show'">
                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="mb-3 col-lg-3">
                                <x-admin.crud.option :label="'Category'" :name="'career_opportunity_category_id'" :model="$model"
                                    :options="$categories
                                        ->map(
                                            fn($category) => [
                                        ...
                                        ->toArray()" :request="request('career_opportunity_category_id')" :required="true" />
                            </div>
                    ...
                    <x-admin.crud.image.card :title="$title">
                        <x-admin.crud.image.card-body>
                            <x-admin.crud.image.main-image :columnValue="$model->image" :name="'image'"
                                :folderName="'career_opportunities'" />
                            {{-- <x-admin.crud.image.other-images :model="$model" :routeName="'career_opportunities'"
                                :imageFolder="'career_opportunity_images'" /> --}}
