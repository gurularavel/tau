    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'roles.store'" :method="'post'">
                    ...
                    <x-admin.crud.tab-content>
                        <x-admin.crud.card-body-row>
                            ...
                            <div class="mb-3 col-lg-6">
                                <x-admin.crud.input :locale="''" :model="''" :columnName="'name'" :label="'title'" :placeholder="'Write a title'" :type="'text'" :required="true" />
                            </div>
                            <div class="mb-3 col-lg-6">
