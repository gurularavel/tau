<x-admin.layout>
    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'student_projects.update'" :method="'update'" :model="$model" :routeNameForBackButton="'student_projects'"
                    :frontRouteName="'student_projects.show'">
    ...
    <x-admin.crud.image.card :title="$title">
        <x-admin.crud.image.card-body>
            <x-admin.crud.image.main-image :columnValue="$model->image" :name="'image'" :folderName="'student_projects'" />
            <x-admin.crud.image.other-images :model="$model" :routeName="'student_projects'" :imageFolder="'student_project_images'" />
