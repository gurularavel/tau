                            ...
                            <div class="col-lg-4">
                                <div class="sticky-side-div">
                                    <div class="card ribbon-box border shadow-none right">
                                        <img src="{{ getImage('student_projects', $model->image) }}" alt=""
                                                                    ...
                                                                    @switch($attribute)
                                                                            ...
                                                                            <div class="flex flex-wrap gap-5">
                                                                                <div class="flex flex-wrap gap-4">
                                                                                    @foreach ($model->images as $gallery)
                                                                                        <a href="{{ asset('uploads/student_project_images/' . $gallery->image) }}"
                                                                        ...
                                                                        @case('actions')
                                                                            <x-admin.crud.index.actions :model="$model"
                                                                                :routeName="'student_projects'" :td="false"
                                                                                :view="false" :delete="true"
                                                                                :frontRouteName="'front.student_projects'" />
                                                                        @break
