        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.index.card>
                    ...
                    <x-admin.crud.index.card-header :title="$title" :routeName="'cvs'"/>
                                    ...
                                    <x-admin.crud.index.table-tbody>
                                        ...
                                        @forelse($models as $index => $model)
                                            <tr>
                                                ...
                                                <x-admin.crud.index.id     :count="$index" />
                                                <x-admin.crud.index.title   :columnName="$model->vacancy?->title" :hyperlinkValue="route('admin.vacancies.show', $model->vacancy->id)" />
                                                <x-admin.crud.index.file :columnName="$model->file"  :folderName="'cvs'"/>
                                                <x-admin.crud.index.actions :model="$model" :routeName="'cvs'"  :delete2="true" :privacy="true" :view="false" :edit="false" :delete="false"/>
