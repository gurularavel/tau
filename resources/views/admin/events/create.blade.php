    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'events.store'" :method="'post'" :routeNameForBackButton="'events'">
                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="mb-3 col-lg-6">
                                <x-admin.crud.option :label="'Event category'" :name="'event_category_id'" :model="$model"
                                    :options="$categories
                                        ->map(
                                            fn($category) => [
                                        ...
                                        ->toArray()" :request="request('event_category_id')" :required="true" />
                            </div>
                    ...
                    <x-admin.crud.image.card :title="$title">
                        <x-admin.crud.image.card-body>
                            <x-admin.crud.image.main-image :columnValue="''" :name="'image'" :folderName="'events'" />
                            <x-admin.crud.image.other-images :model="''" :routeName="'events'" :imageFolder="'event_images'" />
