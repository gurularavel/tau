    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                ...
                <x-admin.crud.card :routeName="'events.update'" :method="'update'" :model="$model" :routeNameForBackButton="'events'"
                    :frontRouteName="'events.show'">
                    ...
                    <x-admin.crud.image.card :title="$title">
                        <x-admin.crud.image.card-body>
                            <x-admin.crud.image.main-image :columnValue="$model->image" :name="'image'"
                                :folderName="'events'" />
                            <x-admin.crud.image.other-images :model="$model" :routeName="'events'"
                                :imageFolder="'event_images'" />
