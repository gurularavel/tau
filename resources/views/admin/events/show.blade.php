                            ...
                            <div class="col-lg-4">
                                <div class="sticky-side-div">
                                    <div class="card ribbon-box border shadow-none right">
                                        <img src="{{ getImage('events', $model->image) }}" alt=""
                                                                ...
                                                                <td class="table-center">
                                                                    @switch($attribute)
                                                                        ...
                                                                        @case('event_category_id')
                                                                            <a target="__blank"
                                                                                href="{{ route('admin.event_categories.show', $model->category->id) }}">{{ $model->category?->title }}</a>
                                                                        @break
                                                                            ...
                                                                            <div class="flex flex-wrap gap-5">
                                                                                <div class="flex flex-wrap gap-4">
                                                                                    @foreach ($model->images as $gallery)
                                                                                        <a href="{{ asset('uploads/event_images/' . $gallery->image) }}"
                                                                        ...
                                                                        @case('actions')
                                                                            <x-admin.crud.index.actions :model="$model"
                                                                                :routeName="'events'" :td="false"
                                                                                :view="false" :delete="true"
                                                                                :frontRouteName="'front.events'" />
                                                                        @break
