    ...
    <div id="layout-wrapper">
        ...
        <x-admin.crud.main-content>
            ...
            <x-admin.crud.page-content>
                    ...
                    <x-admin.crud.card :routeName="'project_categories.update'" :method="'update'" :model="$model" :routeNameForBackButton="'project_categories'" >
                        ...
                        <x-admin.crud.success-message :delay="'5000'"/>
                                ...
                                {{-- <x-admin.crud.image.card :title="$title">
                                    <x-admin.crud.image.card-body>
                                        <x-admin.crud.image.main-image :columnValue="$model->image" :name="'image'" :folderName="'project_categories'"/>
