...
use App\Repositories\Contracts\StudentLifeClubRepositoryInterface;
use Crud\Repositories\EloquentRepository;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Facades\DB;

class StudentLifeClubRepository extends EloquentRepository implements StudentLifeClubRepositoryInterface
{
    public function __construct(StudentLifeClub $model)
    {
