...
use App\Repositories\Contracts\StudentProjectPageRepositoryInterface;
use Crud\Repositories\EloquentRepository;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Facades\DB;

class StudentProjectPageRepository extends EloquentRepository implements StudentProjectPageRepositoryInterface
{
    public function __construct(StudentProjectPage $model)
    {
