...
class DynamicItemRepository extends EloquentRepository implements DynamicItemRepositoryInterface
{
    public function __construct(DynamicItem $model)
    {
