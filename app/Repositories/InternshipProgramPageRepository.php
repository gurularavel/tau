...
class InternshipProgramPageRepository extends EloquentRepository implements InternshipProgramPageRepositoryInterface
{
    public function __construct(InternshipProgramPage $model)
    {
    ...
    {
        return InternshipProgramPage::query()
