...
class InternshipProgramRepository extends EloquentRepository implements InternshipProgramRepositoryInterface
{
    public function __construct(InternshipProgram $model)
    {
