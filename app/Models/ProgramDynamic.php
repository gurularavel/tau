...
class ProgramDynamic extends Model
{
     const TYPE_TITLE = 1;
    ...
    protected $casts = [
        'program_dynamic_item_ids' => 'array',
    ...
    {
        return $this->hasMany(ProgramDynamicImage::class)->orderBy('order');
    }
...
{
    return $this->hasMany(ProgramDynamicItem::class)->orderBy('order');
}
