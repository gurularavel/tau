...
class CareerOpportunityService extends BaseCrudService implements CareerOpportunityServiceInterface
{
    use FileManagable;

    private const FOLDER = 'career_opportunities';

    public function __construct(CareerOpportunityRepositoryInterface $repository)
    {
    ...
    public function create(array $payload, ?UploadedFile $file = null): Model
    {
        ...
        if (isset($payload['images'])) {
            $images = $this->multiUpload('event_images', $payload['images']);
