...
class StudentLifeClubService extends BaseCrudService implements StudentLifeClubServiceInterface
{
    use FileManagable;

    private const FOLDER = 'studentLifeClub';

    public function __construct(
        StudentLifeClubRepositoryInterface $repository,
        )
    {
