...
use App\Services\Contracts\StudentProjectImageServiceInterface;
use App\Traits\FileManagable;
use Crud\Services\BaseCrudService;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Http\UploadedFile;

class StudentProjectImageService extends BaseCrudService implements StudentProjectImageServiceInterface
{
    use FileManagable;

    private const FOLDER = 'student_project_images';
