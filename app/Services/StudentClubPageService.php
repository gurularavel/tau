...
class StudentClubPageService extends BaseCrudService implements StudentClubPageServiceInterface
{
    use FileManagable;

    private const FOLDER = 'studentClubPage';

    public function __construct(
        StudentClubPageRepositoryInterface $repository,
        )
    {
