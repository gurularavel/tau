...
use App\Services\Contracts\AnnouncementImageServiceInterface;
use App\Traits\FileManagable;
use Crud\Services\BaseCrudService;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Http\UploadedFile;

class AnnouncementImageService extends BaseCrudService implements AnnouncementImageServiceInterface
{
    use FileManagable;

    private const FOLDER = 'announcements_images';

    public function __construct(AnnouncementImageRepositoryInterface $repository)
    {
