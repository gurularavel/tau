...
use App\Services\Contracts\ProjectImageServiceInterface;
use App\Traits\FileManagable;
use Crud\Services\BaseCrudService;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Http\UploadedFile;

class ProjectImageService extends BaseCrudService implements ProjectImageServiceInterface
{
    use FileManagable;

    private const FOLDER = 'project_images';
