...
class EventPageService extends BaseCrudService implements EventPageServiceInterface
{
    use FileManagable;

    private const FOLDER = 'eventPage';

    public function __construct(
        EventPageRepositoryInterface $repository,
        )
    {
