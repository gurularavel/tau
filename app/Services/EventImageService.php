...
use App\Services\Contracts\EventImageServiceInterface;
use App\Traits\FileManagable;
use Crud\Services\BaseCrudService;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Http\UploadedFile;

class EventImageService extends BaseCrudService implements EventImageServiceInterface
{
    use FileManagable;

    private const FOLDER = 'event_images';

    public function __construct(EventImageRepositoryInterface $repository)
    {
