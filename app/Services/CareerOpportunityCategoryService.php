...
class CareerOpportunityCategoryService extends BaseCrudService implements CareerOpportunityCategoryServiceInterface
{
    use FileManagable;

    private const FOLDER = 'career_opportunity_categories';


    public function __construct(CareerOpportunityCategoryRepositoryInterface $repository)
    {
