...
class GraduatePageService extends BaseCrudService implements GraduatePageServiceInterface
{
    use FileManagable;

    private const FOLDER = 'graduatePage';

    public function __construct(
        GraduatePageRepositoryInterface $repository,
        )
    {
