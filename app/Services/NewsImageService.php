...
use App\Services\Contracts\NewsImageServiceInterface;
use App\Traits\FileManagable;
use Crud\Services\BaseCrudService;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Http\UploadedFile;

class NewsImageService extends BaseCrudService implements NewsImageServiceInterface
{
    use FileManagable;

    private const FOLDER = 'news_images';

    public function __construct(NewsImageRepositoryInterface $repository)
    {
