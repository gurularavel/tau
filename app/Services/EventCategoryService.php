...
class EventCategoryService extends BaseCrudService implements EventCategoryServiceInterface
{
    use FileManagable;

    private const FOLDER = 'event_categories';


    public function __construct(EventCategoryRepositoryInterface $repository)
    {
