...
class LaboratoryService extends BaseCrudService implements LaboratoryServiceInterface
{
    use FileManagable;

    private const FOLDER = 'laboratories';

    public function __construct(
        LaboratoryRepositoryInterface $repository,
        )
    {
    ...
    public function create(array $payload, ?UploadedFile $file = null): Model
    {
        if (!is_null($file) && isset($payload['image'])) {
            ...
            $images = $this->multiUpload('laboratory_images', $payload['images']);
