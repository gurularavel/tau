...
interface BlockItemServiceInterface extends BaseCrudServiceInterface
{
    ...
    public function updateOrCreateWithTranslations($id,array $data,  array $translations, $file);
}
